...
class EngineTest {
    ...
    @Test
    void testAddOrderAndGetFraudulentQuantityCase1_5() {
//        Engine engine1 = new Engine();
        Order order1 = new Order();
        order1.setId(1);
        order1.setCustomer(10);
        order1.setPrice(100);
        ...
        Order order3 = new Order();
        order3.setId(3);
        order3.setCustomer(10);
        order3.setPrice(100);
        order3.setQuantity(5000);

        int getCostumerFQ = engine.getCustomerFraudulentQuantity(order3);
        assertEquals(5000-10, getCostumerFQ, "Not equal");
